...
function generateImage(event) {
  ...
  for (let entry of Instructions) {
    ...
    let context = `You are a drawing teacher. Your goal is to generate an image from  ${input.value} using the ${choice} drawing style. Provide a picture example with detailed and easy to follow step by step instructions in basic HTML on how to draw the image described. Add a line of space between each step.`;
